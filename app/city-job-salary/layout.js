export const metadata = {
  title: "City Job Salary Explorer — Compare Salaries Across 1,478 Cities | Pulsafi",
  ...
  openGraph: {
    title: "City Job Salary Explorer | Pulsafi",
...
export default function CityJobSalaryLayout({ children }) {
  return children;
}
