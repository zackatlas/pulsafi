...
export default function Article() {
  return (
    ...
    >
      ...
      <h2>The Math: Interest Rate Arbitrage</h2>
      <p>
      ...
      <p>
        <strong>Option A: Pay off $8,000 debt at 4.5%</strong>
      </p>
      <p>
      ...
      <p>
        <strong>Option B: Invest $10,000 at 7% returns</strong>
      </p>
      <p>
      ...
      <div className="data-point">
        ...
        <div className="label">The "arbitrage spread" — the mathematical advantage of investing over paying debt (7% returns minus 4.5% interest cost)</div>
      </div>
      ...
      <h2>But This Assumes You're Rational About Investing</h2>
      <p>
      ...
      <div className="callout">
        <strong>The psychological problem:</strong> You have two financial stressors (debt and market volatility) instead of one. Your anxiety skyrockets. You make emotional decisions. The math doesn't matter if you can't stick with it.
      </div>

      <h2>Comparing Debt Types: Not All Interest Rates Are Equal</h2>
      <p>
        Your answer depends heavily on what debt you have. Let's be honest about the different scenarios:
      </p>

      <h3>Low-Interest Debt (Below 3%): Invest</h3>
      <p>
      ...
      <h3>Medium-Interest Debt (3-7%): It Depends</h3>
      <p>
      ...
      <h3>High-Interest Debt (Above 7%): Pay It Off</h3>
      <p>
      ...
      <div className="data-point">
        <div className="number">18-24%</div>
        <div className="label">Average credit card interest rate in 2026</div>
      </div>

      <h2>The Framework: How to Actually Decide</h2>

      <h3>Step 1: Calculate Your Interest Rate Spread</h3>
      <p>
        Subtract your debt interest rate from your expected investment return. 7% market return - 4.5% debt = 2.5% spread.
      </p>
      <p>
        If the spread is 3%+: investing is clearly better mathematically.<br />
        If the spread is 1-3%: it's close; psychology might override math.<br />
        If the spread is negative or less than 1%: pay the debt.
      </p>

      <h3>Step 2: Assess Your Risk Tolerance Honestly</h3>
      <p>
      ...
      <h3>Step 3: Check Your Emergency Fund</h3>
      <p>
      ...
      <p>
        1. Emergency fund (3-6 months expenses)<br />
        2. High-interest debt (credit cards, payday loans)<br />
        3. Medium-interest debt (personal loans, newer student loans) while investing<br />
        4. Low-interest debt while investing aggressively
      </p>

      <h3>Step 4: Factor in Opportunity Cost (Not Just Interest Rate)</h3>
      <p>
      ...
      <h2>Real Scenarios: What You Should Actually Do</h2>

      <h3>Scenario 1: $8,000 Student Loan at 4.5%, $10,000 Cash</h3>
      <p>
      ...
      <h3>Scenario 2: $5,000 Credit Card at 22%, $10,000 Cash</h3>
      <p>
      ...
      <h3>Scenario 3: $0 Debt, $10,000 Cash, Ability to Invest Regularly</h3>
      <p>
        Invest it. No mental load of debt. Pure upside. The math is perfect and you'll sleep well.
      </p>

      <h3>Scenario 4: $15,000 Debt at 6%, $10,000 Cash</h3>
      <p>
      ...
      <h2>The Hybrid Approach Most People Should Use</h2>
      <p>
      ...
      <p>
        Benefits of investing (compound growth, tax-advantaged accounts, habit building)<br />
        Benefits of debt paydown (interest savings, stress reduction)<br />
      ...
      <div className="callout">
        <strong>The real answer:</strong> Math suggests investing when the spread is positive. Psychology suggests paying debt when interest rates are high or carrying debt causes stress. The best strategy is whichever one you'll actually execute for 10+ years.
      </div>
      ...
      <p>
        <a href="/learn/how-to-start-investing-with-100" style={{ color: "var(--accent)", textDecoration: "none", fontWeight: 600 }}>Getting Started With Investing →</a>
      </p>
    </ArticleLayout>
  );
}
