    ...
    <div style={{ minHeight: "100vh", background: "#0d0f13", color: "#e8e9eb", fontFamily: "'DM Sans', sans-serif" }}>
      ...
      <section style={{
        ...
        <h1 style={{
          ...
          Financial Clarity for <span style={{ color: "#c9a227" }}>Everyone</span>
        </h1>
      </section>
      ...
      <main style={{ maxWidth: 680, margin: "0 auto", padding: "0 24px 60px" }}>
        ...
        <section style={{ marginBottom: 48 }}>
          <div style={{ fontSize: 15, color: "#b8bcc4", lineHeight: 1.85 }}>
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: 16 }}>
            {[
              ...
              <div key={i} style={{
                ...
                <div>
                  <h3 style={{ fontSize: 16, fontWeight: 700, color: "#e8e9eb", margin: "0 0 6px" }}>{value.title}</h3>
                  <p style={{ fontSize: 14, color: "#6a6f78", lineHeight: 1.65, margin: 0 }}>{value.desc}</p>
                </div>
              </div>
            ))}
          </div>
        ...
        <section style={{ marginBottom: 48 }}>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(140px, 1fr))", gap: 16 }}>
            {[
              { num: "50K+", label: "Monthly Users", color: "#c9a227" },
              ...
              <div key={i} style={{
                background: "#14161c", borderRadius: 14, border: "1px solid #1e2028",
                padding: "24px 18px", textAlign: "center",
              }}>
                <div style={{ fontSize: 28, fontWeight: 700, color: stat.color, fontFamily: "'DM Mono', monospace" }}>{stat.num}</div>
                <div style={{ fontSize: 11, color: "#6a6f78", textTransform: "uppercase", letterSpacing: "0.06em", marginTop: 6 }}>{stat.label}</div>
              </div>
            ))}
          </div>
        </section>
        ...
        <section style={{ marginBottom: 48 }}>
          ...
          <div style={{
            background: "#14161c", borderRadius: 14, border: "1px solid #1e2028", padding: "24px 22px",
            fontSize: 14, color: "#8a8f98", lineHeight: 1.75,
          }}>
            <p style={{ marginBottom: 14 }}>
              Transparency matters. Here's exactly how Pulsafi stays free:
            </p>
            <p style={{ marginBottom: 14 }}>
              <strong style={{ color: "#e8e9eb" }}>Advertising.</strong> We display tasteful, relevant ads from financial services companies. We never show pop-ups, auto-play video ads, or anything that disrupts your experience.
            </p>
            <p style={{ marginBottom: 14 }}>
              <strong style={{ color: "#e8e9eb" }}>Affiliate partnerships.</strong> When we recommend a financial product (like a brokerage or lender), we may earn a commission if you sign up. We only recommend products we'd actually use ourselves, and our calculators are never influenced by these partnerships.
            </p>
            <p style={{ margin: 0 }}>
              <strong style={{ color: "#e8e9eb" }}>Newsletter sponsorships.</strong> Brands occasionally sponsor our weekly newsletter. Sponsored content is always clearly labeled.
            </p>
          </div>
        </section>
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: 14 }}>
              {[
                ...
                <div key={i} style={{ display: "flex", alignItems: "center", gap: 14 }}>
                  ...
                  <div>
                    <div style={{ fontSize: 12, color: "#6a6f78", marginBottom: 2 }}>{contact.label}</div>
                    <div style={{ fontSize: 14, color: "#c9a227", fontWeight: 500 }}>{contact.value}</div>
                  </div>
                </div>
              ))}
            </div>
        ...
        <div style={{ textAlign: "center", marginTop: 48 }}>
          ...
          <p style={{ color: "#6a6f78", fontSize: 14, marginBottom: 24 }}>Start with our free calculators — no signup required.</p>
          <a href="/" style={{
