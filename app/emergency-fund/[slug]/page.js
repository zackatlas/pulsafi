...
export default function Page({ params }) {
  ...
  const { salary, familyType } = parsed;
  ...
  const breadcrumbJson = {
    ...
    itemListElement: [
      ...
      { '@type': 'ListItem', position: 3, name: `${formatCurrency(salary)} - ${familyLabel}`, item: `https://pulsafi.com/emergency-fund/${params.slug}` }
    ]
  };
      ...
      <main style={{ backgroundColor: 'var(--bg-main)', color: 'var(--text-primary)', fontFamily: "'DM Sans', sans-serif" }}>
        ...
        <section style={{
          ...
          <div style={{
            ...
            <div style={{
              ...
              <p style={{ fontSize: '0.9rem', opacity: 0.8, marginBottom: '0.5rem' }}>Monthly Expenses</p>
              <p style={{ fontFamily: "'Inter', monospace", fontSize: '1.8rem', fontWeight: 700 }}>
                {formatCurrency(funds.monthlyGross)}
              </p>
            </div>
            <div style={{
              backgroundColor: 'rgba(255,255,255,0.1)',
              ...
              <p style={{ fontSize: '0.9rem', opacity: 0.8, marginBottom: '0.5rem' }}>3-Month Fund</p>
              <p style={{ fontFamily: "'Inter', monospace", fontSize: '1.8rem', fontWeight: 700 }}>
                {formatCurrency(funds.fund3Months)}
              </p>
            </div>
            <div style={{
              backgroundColor: 'rgba(255,255,255,0.1)',
              ...
              <p style={{ fontSize: '0.9rem', opacity: 0.8, marginBottom: '0.5rem' }}>6-Month Fund</p>
              <p style={{ fontFamily: "'Inter', monospace", fontSize: '1.8rem', fontWeight: 700 }}>
                {formatCurrency(funds.fund6Months)}
              </p>
            </div>
            <div style={{
              backgroundColor: 'rgba(255,255,255,0.1)',
              ...
              <p style={{ fontSize: '0.9rem', opacity: 0.8, marginBottom: '0.5rem' }}>12-Month Fund</p>
              <p style={{ fontFamily: "'Inter', monospace", fontSize: '1.8rem', fontWeight: 700 }}>
                {formatCurrency(funds.fund12Months)}
              </p>
            </div>
          </div>
        </section>
              ...
              return (
                <div key={months} style={{ marginBottom: '2rem' }}>
                  <div style={{
                    ...
                    <span style={{ fontFamily: "'Inter', monospace", fontWeight: 600 }}>
          ...
          <div style={{
            ...
            {[
              ...
              },
              {
                ...
                best: 'Best for disciplined savers'
              },
              {
                ...
                best: 'Best for risk-tolerant savers'
              }
            ].map((account) => (
              <div key={account.title} style={{
                backgroundColor: 'var(--bg-card)',
                padding: '1.5rem',
                borderRadius: '12px',
                border: '1px solid var(--border-card)',
                ...
                <div style={{ flex: 1 }}>
                  <p style={{ marginBottom: '0.8rem', fontSize: '0.95rem' }}>
                    <strong>Pros:</strong> {account.pros}
                  </p>
                  <p style={{ marginBottom: '0.8rem', fontSize: '0.95rem' }}>
                    <strong>Cons:</strong> {account.cons}
                  </p>
                </div>
                <p style={{
        ...
        <section style={{
          ...
          <div style={{
            ...
            <div style={{ display: 'grid', gap: '1.5rem' }}>
              {[
                {
                  stage: 'Starting Out (Age 20–30)',
                  target: '3 months of expenses',
                  reasoning: 'You likely have fewer dependents and lower fixed expenses. A 3-month fund provides a safety net without requiring massive savings.'
                },
                {
                  stage: 'Building Stability (Age 30–45)',
                  target: '6 months of expenses',
                  reasoning: 'You may have family, mortgage, or higher responsibilities. A 6-month fund covers longer job searches and major repairs.'
                },
                {
                  stage: 'Pre-Retirement (Age 45–60)',
                  target: '9–12 months of expenses',
                  reasoning: 'Job transitions take longer at this age. A larger fund provides peace of mind as you approach retirement.'
                },
                {
                  stage: 'Retired (Age 60+)',
                  target: '12+ months of expenses',
                  reasoning: 'No regular income means emergencies must come from savings. Prioritize liquidity and preserve capital.'
                }
              ].map((item) => (
        ...
        <section style={{
          ...
          <div style={{ display: 'grid', gap: '1.5rem' }}>
            {[
              {
                q: `What is the recommended emergency fund size for a ${familyLabel} with a ${formatCurrency(salary)} salary?`,
                a: `For a ${familyLabel} earning ${formatCurrency(salary)} annually, we recommend building an emergency fund of ${formatCurrency(funds.fund6Months)} to ${formatCurrency(funds.fund12Months)}, covering 6 to 12 months of essential living expenses. Start with 3 months (${formatCurrency(funds.fund3Months)}) and build up from there.`
              },
              {
                q: 'How quickly can I build this emergency fund?',
                a: `By saving 15% of your gross income monthly (${formatCurrency(Math.round(salary / 12 * 0.15))}), you could reach a 6-month fund in approximately ${savingsPlan[1].months6} months. Saving 20% would achieve this in roughly ${savingsPlan[2].months6} months. Set up automatic transfers to stay on track.`
              },
              {
                q: 'Where should I keep my emergency fund?',
                a: 'Keep your emergency fund in a high-yield savings account (3.5–5% APY), money market account, or short-term Treasury bills. These options provide safety (FDIC insurance), liquidity (quick access), and better returns than traditional savings accounts. Avoid investing emergency funds in stocks.'
              },
              {
                q: 'What counts as a true emergency?',
                a: 'True emergencies include job loss, unexpected medical expenses, major home or car repairs, sudden family crises, or temporary disability. Do not use your emergency fund for vacations, new gadgets, lifestyle upgrades, or planned purchases—these should come from your regular budget.'
              }
            ].map((item, idx) => (
              <div key={idx} style={{
                backgroundColor: 'var(--bg-card)',
            ...
            {[
              {
                ...
                description: 'See exactly how your income breaks down after taxes and deductions.',
                href: '/salary-breakdown-calculator'
              },
              {
                title: 'Debt-to-Income Ratio Calculator',
                description: 'Check your financial health and assess if you can handle more debt.',
                href: '/debt-to-income-calculator'
              },
              {
                title: 'Monthly Budget Calculator',
                description: 'Create a detailed budget to identify savings opportunities.',
