export const metadata = {
  ...
  alternates: {
    canonical: 'https://pulsafi.com/tools',
  },
  openGraph: {
    title: 'Free Financial Calculators & Tools | Pulsafi',
    description: 'Professional-grade financial calculators — free forever, no signup. Mortgage, compound interest, FIRE, debt payoff, budget, net worth, and more.',
    url: 'https://pulsafi.com/tools',
    type: 'website',
    images: [{ url: 'https://pulsafi.com/api/og?title=Free%20Financial%20Tools&subtitle=14%20Professional-Grade%20Calculators&type=tool', width: 1200, height: 630 }],
  },
  twitter: {
    card: 'summary_large_image',
    title: 'Free Financial Calculators & Tools | Pulsafi',
    description: 'Professional-grade financial calculators — free forever, no signup.',
    images: ['https://pulsafi.com/api/og?title=Free%20Financial%20Tools&subtitle=14%20Professional-Grade%20Calculators&type=tool'],
  },
};
